...
import com.eurodyn.qlack2.webdesktop.api.dto.ApplicationInfo.Menu.Type;
...
public class ConverterUtil {
	...
	public static ApplicationInfo applicationToApplicationInfo(Application entity) {
		...
		dto.getInstantiation().setConfigPath(entity.getConfigPath());
		...
		dto.getMenu().setType(new Type());
		dto.getMenu().getType().setDisplayOn(entity.getDisplayOn());
		dto.getMenu().getType().setGroupKey(entity.getGroupKey());
	...
	public static Application applicationInfoToApplication(ApplicationInfo dto) {
		...
		entity.setConfigPath(dto.getInstantiation().getConfigPath());
		...
		entity.setDisplayOn(dto.getMenu().getType().getDisplayOn());
		entity.setGroupKey(dto.getMenu().getType().getGroupKey());
