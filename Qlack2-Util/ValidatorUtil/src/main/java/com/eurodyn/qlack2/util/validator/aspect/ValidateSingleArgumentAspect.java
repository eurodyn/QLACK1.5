...
*/
package com.eurodyn.qlack2.util.validator.aspect;
...
import com.eurodyn.qlack2.util.validator.ValidationUtil;
...
public class ValidateSingleArgumentAspect {
	...
	@Pointcut("execution(@com.eurodyn.qlack2.util.validator.annotation.ValidateSingleArgument * * (..))")
