...
*/
package com.eurodyn.qlack2.util.fileupload.api.rest;
...
public interface FileUploadRest {
	...
	/**
	 * Checks if an attempted upload already exists. This is helpful in order to
	 * support resuming uploads between different browser sessions.
	 * @param req
	 * @param headers
	 * @return
	 */
	CheckChunkResponse checkChunk(
