...
//     */
//    public static HomePageActivityDTO convertActivityModelToDTO(SimHomepageActivity homepageActivity) {
//
...
//     */
//    public static SimHomepageActivity convertActivityDTOTOModel(HomePageActivityDTO homepageActivityDTO) {
//
...
//    }
    ...
    /**
     * Returns array of activity DO as PostItemDTO for a query on HomePageActivity
     * @param query
     * @return PostItemDTOs
     */
//    @SuppressWarnings("unchecked")
//    public static HomePageActivityDTO[] getActivityDTOArrayForHomePageActivityQuery(Query query) {
//        Collection<HomePageActivityDTO> result = new ArrayList<HomePageActivityDTO>();
//
//        for (Iterator<SimHomepageActivity> itr = query.getResultList().iterator(); itr.hasNext();) {
...
//    }
    ...
    /**
     * Return GroupUserDTOs array for a query on SimGroupHasUser
     * and each SocialGroupUserDTO contains all SocialGroupDTO for a user if any
     * This method should be used mostly where list need user and its group list
     * and order by on user id
     *
     * @param query
     * @return array of user IDs
     */
...
//                groupUserDTO.setGroupList(list);
    ...
    public static PostItemDTO[] SIMHomePageActivity_PostItemDTO(Query q, boolean includeChildren,
        ...
        if ((l != null) && (l.size() >0)) {
            ...
            for (int i=0; i<l.size(); i++) {
                ...
                PostItemDTO piDTO = SIMHomePageActivity_PostItemDTO(sha, includeChildren,
                        includeBinary);
                retVal[i] = piDTO;
            }
     ...
     * @return
     */
    public static PostItemDTO SIMHomePageActivity_PostItemDTO(SimHomepageActivity sha,
       ...
       if (includeChildren) {
           TreeSet<PostItemDTO> ts = new TreeSet<PostItemDTO>(
                   new Comparator<PostItemDTO>() {
