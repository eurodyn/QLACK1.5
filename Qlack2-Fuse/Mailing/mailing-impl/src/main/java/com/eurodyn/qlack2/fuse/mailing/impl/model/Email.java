...
public class Email implements java.io.Serializable {
	...
	public static List<Email> findQueued(EntityManager em, byte maxTries) {
		...
		// Using PESSIMISTIC_FORCE_INCREMENT for locking rows to avoid duplicate emails when using multiple mailers.
		...
		try {
			...
			// We do not need to handle it, only to catch it to ensure a thread will query on the updated data.
		}
