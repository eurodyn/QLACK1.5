...
public class EmailDTO implements Serializable {
	...
	public String toString() {
		StringBuilder strBuilder = new StringBuilder("DTO id is: ")
				.append(getId())
				.append("Subject is: ")
				.append(getSubject())
				...
				.append("BCC contact List: ").append(getBccContact() != null ? getBccContact().toString() : null)
				...
				.append("message Id: ").append(messageId).append("sign: ")
				.append(sign);
