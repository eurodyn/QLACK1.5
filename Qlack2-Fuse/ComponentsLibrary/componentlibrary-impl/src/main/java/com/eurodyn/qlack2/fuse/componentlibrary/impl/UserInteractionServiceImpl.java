...
/**
 * An OSGI service to manage the end-user interacting with a gadget. For details regarding the
...
public class UserInteractionServiceImpl implements UserInteractionService {
     ...
     * @throws QlackFuseAPIException {@inheritDoc}
     */
    @Override
    public void addGadgetToHomepage(String gadgetID, String userID, boolean notification) {
        ...
        // Check if the particular gadget has not been already added to the user's homepage.
        Query q = em.createQuery("SELECT a FROM ApiGadgetHasUser a WHERE a.gadget.id = :gadgetId AND a.userId = :userId");
...
//            objectData.put("url",
//                    gadget.getConfigPage() + "?gadgetAdded=" + aghu.getId() + "&gadgetSecretKey=" + gadget.getPrivateKey());
//            try {
//                sendJMSMessageToQlackAPIQueue(objectData);
//            } catch (JMSException ex) {
//                LOGGER.log(Level.SEVERE, ex.getLocalizedMessage(), ex);
//                throw new QlackFuseAPIException(CODES.ERR_API_0004, ex.getLocalizedMessage());
//            }
//        }
        }
    }
...
//            objectData.put("action", "http_call");
//            objectData.put("url",
//                    configURL + "?gadgetRemoved=" + retVal + "&gadgetSecretKey=" + secretKey);
//            try {
//                sendJMSMessageToQlackAPIQueue(objectData);
//            } catch (JMSException ex) {
//                LOGGER.log(Level.SEVERE, ex.getLocalizedMessage(), ex);
...
//        }
    ...
    @Override
        ...
        LOGGER.log(Level.FINEST, "Adding gadget {0} to group {1}. This call is delegated.", new String[]{gadgetID, groupID});
    ...
    @Override
        ...
        LOGGER.log(Level.FINEST, "Removing gadget {0} from group {1}. This call is delegated", new String[]{gadgetID, groupID});
...
//	private Message createJMSMessageForjmsQlackAPIQueue(Session session, Object messageData) throws JMSException {
...
//    private void sendJMSMessageToQlackAPIQueue(Object messageData) throws JMSException {
...
//            messageProducer.send(createJMSMessageForjmsQlackAPIQueue(session, messageData));
//        } finally {
//            if (session != null) {
//                try {
//                    session.close();
