...
public class IDMServiceImpl implements IDMService {
	...
	private AuthenticateResponse authenticate(String username, String password,
		...
		// Set the userID of the user as its username. If this is not an SSO
		// authentication the username will be replaced by the username associated
		// with this user on QLACK AAA; if not, the username will be the userID.
