...
public class ConverterUtil {
    ...
    public static UserDTO userToUserDTO(User entity) {
        ...
        Set<UserAttributeDTO> userAttributeDtos = userAttributesToUserAttributeDTOSet(entity.getUserAttributes(), entity.getId());
        dto.setUserAttributes(userAttributeDtos);

        return dto;
    }

	public static Set<UserAttributeDTO> userAttributesToUserAttributeDTOSet(Collection<UserAttribute> entities, String userId) {
		if (entities == null) {
			return null;
		}
	...
	public static UserAttributeDTO userAttributeToUserAttributeDTO(UserAttribute entity, String userId) {
		if (entity == null) {
			return null;
		}
	...
	public static List<GroupDTO> groupToGroupDTOList(Collection<Group> groups, boolean lazyRelatives) {
	    ...
	    for (Group group : groups) {
    		...
    		if (!lazyRelatives) {
    			addParents(groupIndex, group, dto);
    		}
	...
	private static void addParents(Map<String, GroupDTO> groupIndex, Group group, GroupDTO dto) {
