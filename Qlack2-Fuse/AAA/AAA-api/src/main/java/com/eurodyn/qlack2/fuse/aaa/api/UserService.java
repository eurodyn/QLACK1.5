...
public interface UserService {
	 ...
	 * @throws QPasswordProcessingException
	 ...
	 *
	 * @param dto
	 *            The details of the user to be updated. The user ID is used to
	 *            retrieve the user while the other properties are used to
	 *            update the user data.
	 * @param updatePassword
	 *            If true the user password will also be updated to the value
	 ...
	 *
	 * @param userID
	 *            The ID of the user whose status to retrieve
	 ...
	 *
	 * @param username
	 *            The username of the user trying to be authenticated
	 * @param password
	 *            The password for which to check whether the user can be
	 *            authenticated
	 ...
	 *            An arbitrary ID to be stored together with the newly created
	 ...
	 *            if set to true, all other active sessions for this user will
	 *            be terminated.
	 ...
	 * @param applicationSessionID
	 *            The application session ID of the user session to terminate.
	 ...
	 *
	 * @param userID
	 *            The ID of the user for whom to check the login status
	 ...
	 *
	 * @param username
	 *            The username for which the password is changed. Note that this
	 *            is not the user ID as it is stored in the database.
	 * @param newPassword
	 *            The new password to set. If this value is left null or empty
	 ...
	 *            If true then this method will also check if the user belongs
	 ...
	 *
	 * @param attribute
	 *            The details of the attribute to update. The attribute is
	 *            identified by using the attribute name and the userID.
	 * @param createIfMissing
	 *            If true and an attribute with the specified name does not
	 ...
	 *
	 * @param attributes
	 *            The list of attributes to update. Do not forget to correctly
	 *            set the 'userId' on each of the attributes to be updated.
	 * @param createIfMissing
	 *            If true, missing attributes are created. If false, an
	 ...
	 *
	 * @param userID
	 *            The ID of the user whose attribute to delete.
	 * @param attributeName
	 ...
	 *
	 * @param userID
	 *            The ID of the user owner of the attribute to retrieve
	 * @param attributeName
	 ...
	 *
	 * @param userIDs
	 *            The IDs of the users among which to check. If no user IDs are
	 ...
	 * criteria. <b>NOTE:<b> In the case of attribute based sorting users not
	 ...
	 *
	 * @param criteria
	 *            The criteria based on which the search will be performed
