...
public interface OperationService {
     ...
     * @param operationDTO The details of the operation to update. The operation
     * ID is used to identify the operation while the rest of the operation properties
    ...
    /**
     * Grants a generic operation to a user (ie. an operation not executed on 
     * a specific resource). If the operation is already granted to the
     * user the value of the isDeny flag is updated.
    ...
    /**
     * Grants an operation to a user on a specific resource. If the operation is already granted to the
     * user the value of the isDeny flag is updated.
     * @param userID The ID of the user to grant the operation to
     * @param operationName The name of the operation
     * @param isDeny True if the operation should be denied (negative permission), 
    ...
    /**
     * Grants a generic operation to a group (ie. an operation not executed on 
     * a specific resource). If the operation is already granted to the
     * group the value of the isDeny flag is updated.
    ...
    /**
     * Grants an operation to a group on a specific resource. If the operation is already granted to the
     * user the value of the isDeny flag is updated.
     * @param groupID The ID of the group to grant the operation to
     * @param operationName The name of the operation
     * @param isDeny True if the operation should be denied (negative permission), 
	 ...
	 * method makes the same checks as method isPermitted(String, String, String, boolean) with the 
	 * only difference that checks are performed for a generic operation and not
	 ...
	 * @return true, if the user is allowed the operation.
	 *         false, if the user is denied the operation.
	 *         null, if there is no information available to reply accordingly.
	...
	/**
	 * Checks whether a specific operation, for a specific user, for a specific resource
	 * is allowed. The algorithm checks:
	 * 1) Whether the user is assigned the operation. In this case:
	 * a. If the operation is dynamic the dynamic code is executed to decide whether the
	 * user is permitted the operation.
	 * b. If the operation is not dynamic the deny flag of the UserHasOperation entity
	 * is used to decide whether the user is permitted the operation.
	 * 2) Whether one or more of the user groups are assigned the operation. This check is
	 * performed by calling the isPermittedForGroup method which checks
	 * the whole group hierarchy recursively until a group permission is found. In case
	 * multiple group permissions are found from multiple user group hierarchies the 
	 * prioritisePositive flag is used to decide which permission should be taken into 
	 * account (positive or negative).
	 *
	 * @param userID The id of the user for whom to check the operation
	 * @param operationName The name of the operation to check
	...
	/**
     * Checks whether a specific operation, for a specific group is allowed.
     * The check is performed by checking whether the specified group is assigned the
     * specific operation and, if yes, execute the operation code if the operation is dynamic
     * or check the deny flag of the operation assignment to decide whether the group is permitted
     * the operation. In case no assignment for this operation can be found for the group the
     * group's ancestors are checked recursively until we arrive to a decision.
     *
     * @param groupID The id of the group for which to check the operation
     * @param operationName The name of the operation to check
     * @return true, if the group is allowed the operation.
     *         false, if the group is denied the operation.
     *         null, if there is no information available to reply accordingly. 
	 * @throws QDynamicOperationException If an error occurs while evaluating a dynamic operation.
     */
    ...
    /**
     * Checks whether a specific operation, for a specific group is allowed on a specific resource.
     * Makes the same checks as the isPermittedForGroup method with the different that
     * checks are made on a specific resource and not for a generic operation. 
     * @param groupID The id of the group for which to check the operation
     * @param operationName The name of the operation to check
     * @param resourceObjectID The object of the resource for which to perform the check
     * @return true, if the group is allowed the operation.
    ...
    /**
	 * Retrieves the users who can perform a specific operation. This method will return the same results
	 * as if we had executed the isPermitted method for each individual user
	 * registered in the system.
	 * @param operationName The name of the operation to check
	 * @param checkUserGroups If true the permissions of each user's groups will also be checked
	 * in order to find the users who can perform the specified operation. Otherwise, only
	 * permissions assigned explicitly to users will be checked.
	 ...
	 * in order to find the users who can perform the specified operation. Otherwise, only
	 * permissions assigned explicitly to users will be checked.
	 * @return The IDs of the users who are allowed to perform the specified operation on the specified resource
	 * @throws QDynamicOperationException If an error occurs while evaluating a dynamic operation.
	 */
	...
	/**
	 * Retrieves the users who have been blocked from performing a specific operation. This method will return the same results
	 * as if we had executed the isPermitted method for each individual user
	 * registered in the system.
	 * @param operationName The name of the operation to check
	 * @param checkUserGroups If true the permissions of each user's groups will also be checked
	 * in order to find the users who can perform the specified operation. Otherwise, only
	 * permissions assigned explicitly to users will be checked.
	 * belongs to. If true positive permissions will be given priority, otherwise negative
	 * permissions will be given priority.
	 * @return The IDs of the users who have been blocked from performing the operation
	 * @throws QDynamicOperationException If an error occurs while evaluating a dynamic operation.
	 */
	 ...
	 * belongs to. If true positive permissions will be given priority, otherwise negative
	 * permissions will be given priority.
	 * @return The IDs of the users who have been blocked from performing the specified operation on the specified resource
	 * @throws QDynamicOperationException If an error occurs while evaluating a dynamic operation.
	 */
	...
	/**
	 * Retrieves the groups who can perform a specific operation. This method will return the same results
	 * as if we had executed the isPermitted method for each individual group
	 * registered in the system.
	 * @param operationName The name of the operation to check
	 * @param checkAncestors If true the ancestors of each group will also be checked, otherwise
	 * only the operations assigned explicitly to each group will be checked.
	...
	/**
	 * Retrieves the groups who can perform a specific operation on a resource. This method will return the same results
	 * as if we had executed the isPermitted method for each individual group
	 * registered in the system.
	 * @param operationName The name of the operation to check
	 * @param resourceObjectID The ID of the resource object to check.
	...
	/**
	 * Retrieves the groups who have been blocked form performing a specific operation. This method will return the same results
	 * as if we had executed the isPermitted method for each individual group
	 * registered in the system.
	 * @param operationName The name of the operation to check
	 * @param checkAncestors If true the ancestors of each group will also be checked, otherwise
	 * only the operations assigned explicitly to each group will be checked.
	 * @return The IDs of the groups who have been blocked form performing the operation
	 * @throws QDynamicOperationException If an error occurs while evaluating a dynamic operation.
	 */
	Set<String> getBlockedGroupsForOperation(String operationName, boolean checkAncestors);
	
	/**
	 * Retrieves the groups who have been blocked form performing a specific operation on a resource. This method will return the same results
	 * as if we had executed the isPermitted method for each individual group
	 * registered in the system.
	 * @param operationName The name of the operation to check
	 * @param resourceObjectID The ID of the resource object to check.
	 ...
	 * @param userID The ID of the user for whom to retrieve the permitted operations
	 ...
	 * belongs to. If true positive permissions will be given priority, otherwise negative
	 * permissions will be given priority. This argument is only taken into account if checkUserGroups is true.
	...
	/**
	 * Retrieves the operations which are permitted for a specific user on a specific resource.
	 * @param userID The ID of the user for whom to retrieve the permitted operations
