...
public class TicketServerServiceImpl implements TicketServerService {
	...
	public Set<TicketDTO> findTickets(TicketSearchCriteria criteria) {
		...
		cq = addExpiredCriteria(criteria, cb, cq, root);
		cq = addRevokedCriteria(criteria, cb, cq, root);
	...
	private CriteriaQuery<Ticket> addRevokedCriteria(TicketSearchCriteria criteria, CriteriaBuilder cb,
			CriteriaQuery<Ticket> cq, Root<Ticket> root) {
	...
	private CriteriaQuery<Ticket> addExpiredCriteria(TicketSearchCriteria criteria, CriteriaBuilder cb,
			CriteriaQuery<Ticket> cq, Root<Ticket> root) {
