...
public interface WikiTagService {
     ...
     * @return Set<WikiEntryDTO> wiki entries related to tag
     ...
     * @return List<WikiTagDTO> - List of wiki tag dto which exists in the system.
     */
     ...
     * @param entryId
     * @return List<WikiTagDTO> - list of wiki tag dto
