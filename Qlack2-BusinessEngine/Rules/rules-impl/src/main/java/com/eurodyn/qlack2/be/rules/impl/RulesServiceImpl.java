...
public class RulesServiceImpl implements RulesService {
	...
	@ValidateTicket
	@Override
	public String getLatestFinalizedRuleVersionIdByRuleName(GetRuleVersionIdByNameRequest request) {
		String projectId = request.getProjectId();
		String ruleName = request.getRuleName();
		String name = RuleVersion.findLatestFinalizedIdByRuleName(em, projectId, ruleName);

		LOGGER.log(Level.FINE, "Get latest finalized rule version id by project {0}, working set {1} and name {2}.",
				new Object[]{projectId, ruleName, name});
