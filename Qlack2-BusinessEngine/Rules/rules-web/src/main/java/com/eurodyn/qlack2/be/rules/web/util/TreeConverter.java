...
public class TreeConverter {
	...
	public CompositeNode convert(ProjectDetailsDTO project) {
		...
		addWorkingSetNodes(project, workingSetsNode);

		addRuleNodes(project, rulesNode);

		addModelNodes(project, modelsNode);

		addLibraryNodes(project, librariesNode);
	...
	private void addLibraryNodes(ProjectDetailsDTO project, CompositeNode librariesNode) {
	...
	private void addModelNodes(ProjectDetailsDTO project, CompositeNode modelsNode) {
	...
	private void addRuleNodes(ProjectDetailsDTO project, CompositeNode rulesNode) {
	...
	private void addWorkingSetNodes(ProjectDetailsDTO project, CompositeNode workingSetsNode) {
