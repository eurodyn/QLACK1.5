...
public class ProjectsServiceImpl implements ProjectsService {
	...
	public ProjectDetailsDTO getProjectResources(
		...
		for (Category category : categories) {
			...
			if (category.getForms() != null && !category.getForms().isEmpty()) {
				...
				for (Form form : category.getForms()) {
					...
					checkPermissions(request, signedTicket, formDTOs, form, isOnFormPermitted);
				}
		...
		actionsOnUncategorizedForms(request, projectId, signedTicket, projectDTO);
	...
	private void checkPermissions(GetProjectResourcesRequest request, SignedTicket signedTicket, List<FormDTO> formDTOs,
			Form form, Boolean isOnFormPermitted) {
	...
	/*
	 * Retrieve uncategorised forms, check their permissions and convert  them to DTOs
	 */
	private void actionsOnUncategorizedForms(GetProjectResourcesRequest request, String projectId,
			SignedTicket signedTicket, ProjectDetailsDTO projectDTO) {
