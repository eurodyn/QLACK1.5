...
public interface RuntimeService {
	...
	void signalWorkflowInstance(WorkflowInstanceActionRequest request) throws QInvalidTicketException, QAuthorisationException;
	...
	List<NodeInstanceDTO> getProcessInstanceFullHistory(GetWorkflowInstanceDetailsRequest req);

	Long createWorkflowInstance(WorkflowInstanceRequest request);

	Long startWorkflowInstance(WorkflowInstanceActionRequest request);

	List<NodeInstanceDTO> getProcessInstanceActiveNodes(GetWorkflowInstanceDetailsRequest req);

	String getTaskVariableValueByTaskId(WorkflowTaskActionRequest req);

	List<TaskSummaryDTO> getTasksByStatusByProcessInstanceId(WorkflowTaskActionRequest request);
}
