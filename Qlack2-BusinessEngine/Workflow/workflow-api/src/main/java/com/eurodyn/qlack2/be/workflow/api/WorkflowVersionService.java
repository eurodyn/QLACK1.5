...
public interface WorkflowVersionService {
	...
	String getLatestFinalizedWorkflowVersionIdByWorkflowId(GetWorkflowVersionIdByNameRequest request) throws QInvalidTicketException, QAuthorisationException;
