...
public class ConverterUtil {
	...
	public NodeInstanceDTO nodeInstanceToNodeInstanceDTO(NodeInstanceDesc instance) {
		NodeInstanceDTO dto = new NodeInstanceDTO();
		dto.setConnection(instance.getConnection());
		dto.setDataTimeStamp(instance.getDataTimeStamp());
		dto.setDeploymentId(instance.getDeploymentId());
		dto.setId(instance.getId());
		dto.setName(instance.getName());
		dto.setNodeId(instance.getNodeId());
		dto.setNodeType(instance.getNodeType());
		dto.setProcessInstanceId(instance.getProcessInstanceId());
		dto.setType(instance.getType());
		dto.setWorkItemId(instance.getWorkItemId());
		return dto;
	}
	
	public List<NodeInstanceDTO> nodeInstanceToNodeInstanceDTOList(List<NodeInstanceDesc> instances) {

		if (instances == null)
	        return null;

		List<NodeInstanceDTO> dtos = new ArrayList<>();
		for (NodeInstanceDesc instance : instances) {
			dtos.add(nodeInstanceToNodeInstanceDTO(instance));
		}
		return dtos;
	}
	...
	public TaskSummaryDTO taskSummaryToTaskSummaryDTO(TaskSummary summary) {
		...
		dto.setCompletionTime(summary.getCompletionTime());
