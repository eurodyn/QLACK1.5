...
public class ProjectServiceImpl implements ProjectService {
	...
	public ProjectResourcesDTO getProjectResources(GetProjectResourcesRequest req) {
		...
		categorizeWorkflows(req, signedTicket, projectDTO, categories, categoryDTOs);
		...
		for (Workflow workflow : workflows) {
			...
			checkPermission(signedTicket, workflowDTOs, workflow, isOnWorkflowPermitted);
		}
	...
	private void categorizeWorkflows(GetProjectResourcesRequest req, SignedTicket signedTicket, ProjectResourcesDTO projectDTO,
			List<Category> categories, List<CategoryDTO> categoryDTOs) {
	...
	private void checkPermission(SignedTicket signedTicket, List<WorkflowDTO> workflowDTOs, Workflow workflow,
			Boolean isOnWorkflowPermitted) {
