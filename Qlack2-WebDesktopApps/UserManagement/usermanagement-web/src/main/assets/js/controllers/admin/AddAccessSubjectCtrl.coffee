angular
	...
	.controller 'AddAccessSubjectCtrl', ['$scope', '$state', '$stateParams', 'WindowService', 'UserHttpService', 'GroupHttpService', '$timeout', 'ConfigHttpService', \
	($scope, $state, $stateParams, WindowService, UserHttpService, GroupHttpService, $timeout, ConfigHttpService) ->
...
#			Apparently this is the way recommended by Kendo to clear a treeview selection
		...
		$scope.add = () ->
			...
			ConfigHttpService.manageSubject(subjectId).then(
				success = (result) ->
